...
extension Metadata {
    struct Class: NominalType {
        ...
        var superclass: Class? {
            ...
            // If the superclass does'nt conform to handyjson/handyjsonenum protocol,
        ...
        func _propertiesAndStartPoint() -> ([Property.Description], Int32?)? {
            ...
            if let superclass = superclass,
                String(describing: unsafeBitCast(superclass.pointer, to: Any.Type.self)) != "SwiftObject",
